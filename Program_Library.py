...
def task_1(robot_group):
    ...
    robot_group.gimbal.recenter(180,180)
...
def task_3(robot_group):
    ...
    robot_group.gimbal.recenter(90,90).wait_for_completed()
...
def task_6(robot_group):
    ...
    robot_group.gimbal.moveto(0, 90, 0, 360).wait_for_completed()
    ...
    for robot_id in range(0,6): # 0 1 2 3 4 5
        ...
        robot_obj.gimbal.moveto(0, -90, 0, 360).wait_for_completed()
        robot_obj.play_sound(0x101,times=robot_id+1).wait_for_completed(0.5)
        robot_obj.blaster.fire(fire_type='ir', times=1)
        robot_obj.play_sound(0x101)
        robot_obj.blaster.set_led(brightness=0, effect='off')
        robot_obj.led.set_led(led.COMP_TOP_ALL, 255, 255, 255, led.EFFECT_ON)

    for robot_id in range(0,6,-1): # 0 1 2 3 4 5
        light-=42
        robot_obj=robot_group.get_robot(robot_id)
        robot_obj.led.set_led(led.COMP_TOP_ALL, 255, 255, 255, led.EFFECT_ON)
        robot_obj.led.set_led(led.COMP_TOP_ALL, 255, 255, 255, led.EFFECT_SCROLLING)
...
def task_7(robot_group):
    ...
    for times in range(0,5,2):# 0 2 4
        robot_group.gimbal.moveto(20, 0, 0, 20).wait_for_completed()
        robot_group.gimbal.moveto(-20, 0, 0, 20).wait_for_completed()
        robot_group.play_sound(music+2)
        time.sleep(0.5)
...
def task_8_01(robot_group):
    ...
    robot_group.set_group_robots_mode(mode="free")
    time.sleep(1)
    robot_group.chassis.move(0.5,0,0,1,30).wait_for_completed()
    robot_group.led.set_led(led.COMP_ALL, 255, 255, 255, led.EFFECT_FLASH,5)
    time.sleep(0.5)
    ep0.led.set_led(led.COMP_ALL, 255, 1, 1, led.EFFECT_ON)
    ep1.led.set_led(led.COMP_ALL, 1, 1, 255, led.EFFECT_ON)
    robot_group.gimbal.moveto(0, -90, 0, 180)
    robot_group.chassis.move(0,-1,0,1,30).wait_for_completed()
...
def task_8_45(robot_group):
    ...
    robot_group.led.set_led(led.COMP_ALL, 255, 255, 255, led.EFFECT_FLASH,5)
    time.sleep(0.5)
    ep4.led.set_led(led.COMP_ALL, 255, 1, 1, led.EFFECT_ON)
...
def task_8_23(robot_group):
    ...
    robot_group.led.set_led(led.COMP_ALL, 255, 255, 255, led.EFFECT_FLASH,5)
    time.sleep(0.5)
    ep2.led.set_led(led.COMP_ALL, 255, 1, 1, led.EFFECT_ON)
...
def task_10_red(robot_group):
    ...
    robot_group.gimbal.moveto(0, 0, 90, 45).wait_for_completed()
...
def task_11(robot_group):
    ...
    ep0.chassis.move(0,1,0,0.5,90)
    ep1.chassis.move(0,-1,0,0.5,90).wait_for_completed()

    ep0.gimbal.moveto(0, 180, 180, 180)
    ep1.gimbal.moveto(0, -180, 180, 180).wait_for_completed()

    ep0.chassis.move(-1,0,0,0.5,90)#调整余下机器人位置
    ep1.chassis.move(-1,0,0,0.5,90).wait_for_completed(0.5)
    ep2.chassis.move(0.5,0,0,0.5,90)
    ep3.chassis.move(0.5,0,0,0.5,90)
    ep4.chassis.move(0.5,0,0,0.5,90)
    ep5.chassis.move(0.5,0,0,0.5,90).wait_for_completed()

    ep0.chassis.move(0,-0.5,0,0.5,90)#调整01机器人
    ...
    ep2.chassis.move(0,1,0,0.5,90)
    ep3.chassis.move(0,-1,0,0.5,90).wait_for_completed()

    ep2.gimbal.moveto(0, 180, 180, 180)
    ep3.gimbal.moveto(0, -180, 180, 180).wait_for_completed()

    ep2.chassis.move(-1,0,0,0.5,90)#调整余下机器人位置
    ep3.chassis.move(-1,0,0,0.5,90).wait_for_completed(0.5)
    ep4.chassis.move(0.5,0,0,0.5,90)
    ep5.chassis.move(0.5,0,0,0.5,90)
    ep0.chassis.move(0.5,0,0,0.5,90)
    ep1.chassis.move(0.5,0,0,0.5,90).wait_for_completed()

    ep2.chassis.move(0,-0.5,0,0.5,90)#调整23机器人
    ...
    ep4.chassis.move(0,1,0,0.5,90)
    ep5.chassis.move(0,-1,0,0.5,90).wait_for_completed()

    ep4.gimbal.moveto(0, 180, 180, 180)
    ep5.gimbal.moveto(0, -180, 180, 180).wait_for_completed()

    ep4.chassis.move(-1,0,0,0.5,90)#调整余下机器人位置
    ep5.chassis.move(-1,0,0,0.5,90).wait_for_completed(0.5)
    ep0.chassis.move(0.5,0,0,0.5,90)
    ep1.chassis.move(0.5,0,0,0.5,90)
    ep2.chassis.move(0.5,0,0,0.5,90)
    ep3.chassis.move(0.5,0,0,0.5,90).wait_for_completed()

    ep4.chassis.move(0,-0.5,0,0.5,90)#调整45机器人
